...
- Create the following components in separate files inside component folder.
In each one, just render an 'h1' with the name of the component (eg. return
...
- Go to Google fonts and get the"Inter" font with weights 400, 600, and 700.
  Put the links to those fonts ABOVE the style css link in index.html (Use
    ...
    the fonts. You may need to do some extra research to figure out how 
    this works )
